 ...
 */
 ...
 function create_post_type() {
     /*Max 20 characters for post-type name, only letters, no - or _*/
    ...
    register_post_type( 'guard',
		array(
			'labels' => array(
				'name' => __( 'Service de garde' ),
				'singular_name' => __( 'Service de garde' )
			),
			'public' => true,
			'has_archive' => true,
		)
...
function twentyfifteen_setup() {
	...
	register_nav_menus( array(
        ...
        'footer'  => __( 'Footer Nav Menu', 'csiangleur' ),
	) );
